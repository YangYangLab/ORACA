function im = vid_zproject_mean_norm(mov)
%VID_ZPROJECT_MEAN_NORM Z-Project of a movie using average statistics and normalisation
%   IM = VID_ZPROJECT_MEAN_NORM(MOV) projects MOV onto the first two dimensions and
